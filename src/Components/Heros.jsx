      ...
      <div className="px-4 py-5 my-5 text-center">
        ...
        <div className="col-lg-6 mx-auto">
          <p className="lead mb-4">
            ...
            mobile-first sites with Bootstrap, the world’s most popular front-end open
        ...
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div className="col-lg-6">
            ...
            <p className="lead">
              ...
              Bootstrap, the world’s most popular front-end open source toolkit, featuring
      ...
      <div className="container my-5">
        <div className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
          ...
          <div className="col-lg-4 offset-lg-1 p-0 overflow-hidden shadow-lg">
            <img className="rounded-lg-3" src="/assets/images/bootstrap-docs.png" alt="" width="720" />
          </div>
        </div>
      </div>
